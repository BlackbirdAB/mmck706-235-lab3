...
def test_back_track_after_moving(robot):
    robot.move()
    robot.back_track()
    state = robot.state()
    assert state['direction'] == Direction.NORTH
...
def test_back_track_after_turning(robot):
    robot.turn()
    robot.back_track()
    state = robot.state()
    assert state['direction'] == Direction.NORTH
...
def test_back_track_once_after_moving_thrice(robot):
    robot.move()
    robot.move()
    robot.move()
    robot.back_track()
...
def test_back_track_thrice_after_moving_thrice(robot):
    robot.move()
    robot.move()
    robot.move()
    robot.back_track()
